...
const UPGRADE_DEFINITIONS: UpgradeDefinition[] = [
    ...
    { id: 'ranged-attack', name: 'Ranged Pellet Attack', description: 'Unlock pellet projectiles for ranged combat. Center tile flashes orange on each shot. Level 2: Enhanced range, damage, and speed.', maxLevel: 2 },
];
